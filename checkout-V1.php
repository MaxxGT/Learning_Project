				...
				if(!empty($_SESSION['order_qty']))
				{
					for($i=0; $i<$_SESSION['order_qty']; $i++)
					{
						...
						if(strpos($product_id, 'PKG_') !== false)
						{
							...
							VALUES('$order_num', '$product_ids2', '$order_product_class', '$product_name_gas', '$promotion_product_model', '$promotion_unit_price', '$promotion_product_handling', '$promotion_package_point', '$product_sale_percentage', '$pro_amount')";
						...
						}else
						{
							...
							if($member_commercial_status == '0')
							{
								...
								{
									$prd_points = $product_point + ($product_point * 2);
							...
							}else if($member_commercial_status == '1')
							{
								...
								if($member_commercial_class == '1')
								{
									...
									{
										$prd_points = $product_commercial_point + ($product_commercial_point * 2);
